...
class DataTransformation:
    ...
    def get_data_trasnformation(self):
        try:
            ...
            # defining cols for Ordinal encoding
    ...
    def initialize_data_transformation(self, train_path, test_path):
        try:
            ...
            preprocessing_obj = self.get_data_trasnformation()
            ...
            logging.info("Applying preprocessing object n training and testing datasets..")

            train_arr = np.c_[input_feature_train_arr, np.array(target_feature_train_df)]  # input features +  target feature
